            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <defs>
                    <symbol viewBox="0 0 60 60" id="eleme">
                        <path fill="#3CABFF" fillRule="evenodd"
                    ...
                    <symbol viewBox="0 0 32 32" id="speed">
                        <path fill="#37c7b7"
                              d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16zm0-2C8.268 30 2 23.732 2 16S8.268 2 16 2s14 6.268 14 14-6.268 14-14 14z"></path>
                        <path fill="#37c7b7"
                              d="M15 7v11.002l5.678 4.882 1.304-1.517-5.33-4.583.348.758V6.999h-2z"></path>
                    </symbol>
                    <symbol viewBox="0 0 50 50" id="cart-minus">
                        <path fillRule="evenodd" stroke-width="4"
                        ...
                        <path fillRule="evenodd" d="M32 20c1.1 0 2 .9 2 2s-.9 2-2 2H12c-1.1 0-2-.9-2-2s.9-2 2-2h20z"
                              clip-rule="evenodd"></path>
                    </symbol>
                    ...
                    <symbol viewBox="0 0 24 32" id="cart-remove">
                        <path fill="#bbb" fillRule="evenodd"
                    ...
                    <symbol viewBox="0 0 58 58" id="cart-icon">
                        ...
                        <g fill="none" fillRule="evenodd" filter="url(#a)" transform="translate(3 2)">
                            <g transform="translate(5.038 7.808)">
                                ...
                                <path fill="#2073C1" d="M53.962 7.774l-5.701 19.305-40.78 1.574z" opacity=".1"
                                      mask="url(#c)"/>
                            </g>
                    ...
                    <symbol viewBox="0 0 1024 1024" id="res-bad">
                        <path fill="#D0021B" fillRule="evenodd"
                    ...
                    <symbol viewBox="0 0 1024 1024" id="arrow-right" className="icon">
                        <path
                    ...
                    <symbol viewBox="0 0 40 40" id="service">
                        ...
                        <path d="M0 0h40v40H0z" className="st1"></path>
                    </symbol>
                    <symbol viewBox="0 0 120 120" id="select">
                        <circle cx="60" cy="60" r="60"></circle>
                        <path fill="#FFF"
                              d="M63.84 84.678a1.976 1.976 0 0 1-.387.545l-7.975 7.976a1.996 1.996 0 0 1-2.829-.005L24.172 64.716a2.005 2.005 0 0 1-.005-2.828l7.976-7.976a1.996 1.996 0 0 1 2.828.005l19.015 19.015L91.498 35.42a1.991 1.991 0 0 1 2.823 0l7.976 7.977c.784.784.78 2.043 0 2.823L63.84 84.678z"></path>
                    </symbol>
                    <symbol xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 72 72" id="sdk_icon_zhifubao@2x">
                        <defs>
                            <path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36z"
                                  id="sdk_icon_zhifubao@2x_a"></path>
                        </defs>
                        <g fill="none" fillRule="evenodd">
                            <mask id="sdk_icon_zhifubao@2x_b" fill="#fff">
                                <use xlinkHref="#sdk_icon_zhifubao@2x_a"></use>
                            </mask>
                            <use fill="#00A1E9" xlinkHref="#sdk_icon_zhifubao@2x_a"></use>
                            <path
                                ...
                                fill="#FFF" mask="url(#sdk_icon_zhifubao@2x_b)"></path>
                        </g>
                    </symbol>
